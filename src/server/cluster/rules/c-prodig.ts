...
export const checkCProdig: ClusterRuleFn = (f, ctx) => {
  ...
  return makeAssignment("C_PRODIG", ctx, [
    ...
    { label: "First order = Ebook/Buku, bukan HP/Amandia", passed: true, actual: true },
